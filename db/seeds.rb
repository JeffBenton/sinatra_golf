jeff = User.new(email: "test@test.com", username: "jeff", password: "test", is_admin: true)
mike = User.new(email: "test2@test.com", username: "mike", password: "test", is_admin: false)
